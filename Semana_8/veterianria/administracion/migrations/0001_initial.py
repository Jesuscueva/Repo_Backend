    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mascotaSexo', models.CharField(choices=[('M', 'MACHO'), ('H', 'HEMBRA')], db_column='mascota_sexo', max_length=1)),
                ...
                ('tipo', models.ForeignKey(db_column='tipo_id', on_delete=django.db.models.deletion.PROTECT, related_name='mascotaTipo', to='administracion.tipomodel')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Historial',
            fields=[
                ('historiaId', models.AutoField(db_column='historial_id', primary_key=True, serialize=False, unique=True)),
                ('historiaCanje', models.BooleanField(db_column='historial_canje', default=True)),
                ('mascota', models.ForeignKey(db_column='mascota_id', on_delete=django.db.models.deletion.PROTECT, related_name='historiaMascota', to='administracion.mascotamodel')),
